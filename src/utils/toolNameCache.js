// Tool Name Mapping Cache: Dimension by sessionId + model + safeName
// Solution: Tool names must be sanitized when sent upstream, and restored to original names when returning
...
// Prune cache based on memory pressure
