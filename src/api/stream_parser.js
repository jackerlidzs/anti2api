...
// Register memory cleanup callback (for external unified call)
...
// Attempts to restore original tool name from safe tool name
...
// Parse and emit stream response chunk (modifies state and triggers callback)
// Support DeepSeek format: reasoning content output via reasoning_content field
// Also pass through thoughtSignature for client reuse
