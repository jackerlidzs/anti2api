...
async function testTokenRotation() {
  console.log('=== Start Token Rotation Test ===\n');
  ...
  for (let i = 1; i <= totalTests; i++) {
    ...
    console.log(`  Remaining Account: ${tokenManager.tokens.length}\n`);
  ...
  console.log(`Unique Accounts Used: ${usedTokens.size}`);
  ...
  if (usedTokens.size === tokenManager.tokens.length) {
    console.log('\n✅ All accounts were rotated correctly');
  } else {
